##### This code is developed to find important handcrafted features  ####
...
fou_X = min_max_scaler.fit_transform(fou_X)
fou_XI = min_max_scaler.fit_transform(fou_XI)
fou_Y = min_max_scaler.fit_transform(fou_Y)
fou_YI = min_max_scaler.fit_transform(fou_YI)
...
for j in range(1):
    ...
    model.fit(X_train1,newYtrain)
    print(model.feature_importances_)


    model1 = LogisticRegression()
    rfe = RFE(model1, 30)
    fit = rfe.fit(X_train1, newYtrain)
